                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                                <p>Sign up and start Contributing to your Constituency along with friends .
                            	</p>
                            </div>
                        </div>
                    </div>
	                            ...
	                            <div class="form-bottom">
				                    <form action="register.php" method="POST" class="registration-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php 
                                            if(in_array("Your passwords doesn't match", $error_array)) echo "You passwords doesn't match";
        	...
        	<div class="container">
        		<div class="row">
        			...
        			<div class="col-sm-8 col-sm-offset-2">
        				...
        				<p>Website designed and developed by <strong>N Murali Krishna</strong>&nbsp;<i class="fas fa-copyright"></i></p>
        			</div>
